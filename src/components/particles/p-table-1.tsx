...
/**
 * Sample particle from coss ui (MIT: apps/ui/registry/default/particles).
 * Reference pattern for dense tables + status badges; adapt for real data.
 */
...
export function ParticleTableProjectsSample() {
  return (
    <Table>
